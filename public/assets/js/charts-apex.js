...
(function() {
    ...
    // --------------------------------------------------------------------
    const candlestickActivityEl = document.querySelector('#candleStickActivity'),
        candlestickActivityConfig = {
            chart: {
                height: 300,
                fontFamily: 'IBM Plex Sans',
                type: 'candlestick',
            ...
            series: [{
                data: [{
                        x: new Date(15387786005008000),
                        y: [150, 170, 50, 100, 30, 10]
                    },
                    {
                        x: new Date(1538780400000),
                        y: [200, 400, 30, 10, 170, 330]
                    },
                    {
                        x: new Date(1538782200000),
                        y: [330, 340, 250, 280, 30, 10]
                    },
                    {
                        x: new Date(1538784000000),
                        y: [300, 330, 30, 10, 200, 320]
                    },
                    {
                        x: new Date(1538785800000),
                        y: [30, 10, 320, 450, 280, 350]
                    },
                    {
                        x: new Date(1538787600000),
                        y: [300, 350, 30, 10, 80, 250]
                    },
                    {
                        x: new Date(1538789400000),
                        y: [200, 330, 170, 30, 10, 300]
                    },
                    {
                        x: new Date(1538791200000),
                        y: [200, 30, 10, 220, 70, 130]
                    },
                    {
                        x: new Date(1538793000000),
                        y: [220, 270, 180, 10, 220, 250]
                    },
                    {
                        x: new Date(1538794800000),
                        y: [200, 250, 80, 10, 220, 100]
                    },
                    {
                        x: new Date(1538796600000),
                        y: [150, 10, 220, 170, 50, 120]
                    },
                    {
                        x: new Date(1538798400000),
                        y: [10, 220, 110, 450, 10, 420]
                    },
                    {
                        x: new Date(1538800200000),
                        y: [400, 480, 300, 320, 10, 220]
                    },
                    {
                        x: new Date(1538806000000),
                        y: [400, 10, 220, 480, 300, 320]
                    },
                    {
                        x: new Date(1538806800900),
                        y: [10, 220, 400, 480, 300, 320]
                    },
                    {
                        x: new Date(1538802000000),
                        y: [380, 480, 350, 10, 220, 450]
                    }
                ]
            }],
            xaxis: {
    ...
    if (typeof candlestickActivityEl !== undefined && candlestickActivityEl !== null) {
        const candlestickActivity = new ApexCharts(candlestickActivityEl, candlestickActivityConfig);
        candlestickActivity.render();
    }
