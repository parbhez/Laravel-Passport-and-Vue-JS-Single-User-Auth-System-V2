...
(function() {
    ...
    // data process - Multi Radial Bar Chart
    // --------------------------------------------------------------------
    const dataprocessRadialChartEl = document.querySelector('#dataprocessRadialChart'),
        dataprocessRadialChartConfig = {
            chart: {
                height: 270,
                type: 'radialBar'
            },
            ...
            labels: ['Processing', 'Preparing', 'Ready'],
            legend: {
                show: true,
                position: 'bottom',
                horizontalAlign: 'center',
    ...
    if (typeof dataprocessRadialChartEl !== undefined && dataprocessRadialChartEl !== null) {
        const dataprocessRadialChart = new ApexCharts(dataprocessRadialChartEl, dataprocessRadialChartConfig);
        dataprocessRadialChart.render();
    }
