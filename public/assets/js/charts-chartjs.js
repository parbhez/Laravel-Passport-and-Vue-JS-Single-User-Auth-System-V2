...
(function() {
    ...
    const lineChartMonitor = document.getElementById('lineChartMonitor');
    if (lineChartMonitor) {
        const lineChartMonitorVar = new Chart(lineChartMonitor, {
            type: 'line',
            data: {
                labels: ['25/11/22', '26/11/22', '27/11/22', '28/11/22', '29/11/22', '30/11/22', '1/12/22', '2/12/22', '3/12/22', '4/12/22', '5/12/22', '6/12/22', '7/12/22', '8/12/22', '9/12/22', '10/12/22', '11/12/22', '12/12/22', '13/12/22', '14/12/22'],
                datasets: [{
                        data: [80, 150, 180, 270, 210, 160, 160, 202, 265, 210, 270, 255, 290, 360, 375, 300, 500],
                        label: '# friendshipday',
                        borderColor: config.colors.danger,
                        tension: 0.5,
                        pointStyle: 'circle',
                    ...
                    {
                        data: [80, 125, 105, 130, 215, 195, 140, 160, 230, 300, 220, 170, 210, 200, 280, 350],
                        label: '# lewandowski',
                        borderColor: config.colors.primary,
                        tension: 0.5,
                        pointStyle: 'circle',
    ...
    const lineChartTrend = document.getElementById('lineChartTrend');
    if (lineChartTrend) {
        const lineChartTrendVar = new Chart(lineChartTrend, {
            type: 'line',
            data: {
                labels: ['25/11/22', '26/11/22', '27/11/22', '28/11/22', '29/11/22', '30/11/22', '1/12/22', '2/12/22', '3/12/22', '4/12/22', '5/12/22', '6/12/22', '7/12/22', '8/12/22', '9/12/22', '10/12/22', '11/12/22', '12/12/22', '13/12/22', '14/12/22'],
                datasets: [
                    ...
                    {
                        data: [0, 0, 0, 0, 0, 0, 80, 125, 105, 130, 215, 195, 140, 160, 300, 220, 170, 210, 200, 280],
    ...
    // Emotion Chart Emotion
    // --------------------------------------------------------------------

    const lineChartEmotion = document.getElementById('lineChartEmotion');
    if (lineChartEmotion) {
        const lineChartEmotionVar = new Chart(lineChartEmotion, {
            type: 'line',
            data: {
                labels: ['25/11/22', '26/11/22', '27/11/22', '28/11/22', '29/11/22', '30/11/22', '1/12/22', '2/12/22', '3/12/22', '4/12/22', '5/12/22', '6/12/22', '7/12/22', '8/12/22', '9/12/22', '10/12/22', '11/12/22', '12/12/22', '13/12/22', '14/12/22'],
                datasets: [
    ...
    if (regionChart) {
        const regionChartVar = new Chart(regionChart, {
            type: 'polarArea',
            data: {
                labels: ['Barisal', 'Chittagong', 'Dhaka', 'Khulna', 'Mymensingh', 'Rajshahi', 'Rangpur', 'Sylhet'],
                datasets: [{
                    label: 'Population (millions)',
                    backgroundColor: [purpleColor, yellowColor, orangeColor, oceanBlueColor, greyColor, cyanColor, blueColor, blueLightColor],
                    data: [919, 817, 980, 715, 687, 780, 510, 630],
                    borderWidth: 0
                }]
            },
            options: {
    ...
    const regionViralChart = document.getElementById('regionViralChart');
    if (regionViralChart) {
        const regionViralChartVar = new Chart(regionViralChart, {
            type: 'polarArea',
            data: {
                labels: ['Barisal', 'Chittagong', 'Dhaka', 'Khulna', 'Mymensingh', 'Rajshahi', 'Rangpur', 'Sylhet'],
                datasets: [{
    ...
    if (ageChart) {
        const ageChartVar = new Chart(ageChart, {
            type: 'doughnut',
            data: {
                labels: ['35+', '25-34', '18-24'],
                datasets: [{
                    data: [35, 10, 55],
                    backgroundColor: [cyanColor, orangeLightColor, config.colors.primary],
                    borderWidth: 0,
